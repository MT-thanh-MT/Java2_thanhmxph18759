...
public class Oclock extends javax.swing.JFrame implements Runnable{
    ...
    private void initComponents() {
        ...
        btnOclock.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        btnOclock.setForeground(new java.awt.Color(153, 0, 153));
        btnOclock.setText("CLICK ME");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(63, 63, 63)
                .addComponent(btnOclock, javax.swing.GroupLayout.PREFERRED_SIZE, 266, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(73, 73, 73)
                .addComponent(btnOclock, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnOclockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOclockActionPerformed
        ...
        t1.start();
        this.btnOclock.setEnabled(false);
